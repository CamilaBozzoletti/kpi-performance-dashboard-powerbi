...
The dashboard is built on a structured dataset, where raw data was processed and transformed into aggregated indicators and KPIs, which are visualized to support performance analysis.

The solution was developed in Power BI, leveraging:
- Definition and selection of relevant KPIs
- Data modeling to ensure consistency and usability
...
- Comparative analysis of performance across different years, including variations between periods
- Strengths and weaknesses across different business perspectives (financial, customer, processes, learning)
